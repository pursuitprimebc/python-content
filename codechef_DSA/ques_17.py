...
for i in range(t):
    p = int(input())
    ques_with_100point = p//100 
    remaining_points = p%100 
    if (ques_with_100point + remaining_points) <= 10:
        print(ques_with_100point+remaining_points)
    else:
        print('-1')
