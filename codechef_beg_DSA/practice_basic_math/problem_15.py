...
Santosh comes to know that he will get more money if he sells square shaped plots. So keeping this in mind, he decides to divide his land into 
minimum possible number of square plots, such that each plot has the same area, and the plots divide the land perfectly. He does this in order to get the maximum profit out of this.
...
for i in range(t):
    ...
    l_of_sqr = math.gcd(n,m)
    area_of_sqr = l_of_sqr*l_of_sqr
    area_of_rect = n*m 
    no_of_sqr_plots = area_of_rect//area_of_sqr
    print(no_of_sqr_plots)
