'''QUESTION - hessboard Distance
The Chessboard Distance for any two points (X1,Y1)(X1,Y1) and (X2,(X2,Y2) on a Cartesian plane is defined as max(|X1-X2|,|Y1-Y2|).

You are given two points (X1,(X1,Y1)and (X2,(X2,Y2). Output their Chessboard Distance.
